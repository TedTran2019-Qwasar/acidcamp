...
ActiveRecord::Schema[7.0].define(version: 20_220_804_223_844) do
  ...
  create_table 'project_shares', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[project_id user_id], name: 'index_project_shares_on_project_id_and_user_id', unique: true
